...
def test_hsl():
    cplot.savefig(
        "z1.png", lambda z: z ** 1, -2, +2, -2, +2, 101, 101, colorspace="hsl"
    )
    cplot.savefig(
        "z2.png", lambda z: z ** 2, -2, +2, -2, +2, 101, 101, colorspace="hsl"
    )
    cplot.savefig(
        "z3.png", lambda z: z ** 3, -2, +2, -2, +2, 101, 101, colorspace="hsl"
    )
